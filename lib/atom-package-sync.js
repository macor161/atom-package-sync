...
const LOGOUT_SUCCESS_MESSAGE = 'User logged-out successfully'
...
class AtomPackageSync {
    ...
    activate(state) {
        ...
        setTimeout(() => {
            ...
            atom.commands.add('atom-workspace', "atom-package-sync:logout", () => {
              this._qlApi.logoutUser()
              atom.notifications.addSuccess(LOGOUT_SUCCESS_MESSAGE)
            })
