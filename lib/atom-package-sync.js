...
let asyncjs
let StateManager
let { QuantalApi, QError, QuantalError } = { QuantalApi: null, QError: null,  QuantalError: null }
...
class AtomPackageSync {
                        ...
                        asyncjs.eachSeries(changes, (change, next) => {
                                ...
                                switch (change.status) {
                                    ...
                                    case SyncStatus.PackageSettingsChangedFromServer:
                                        func = () => this.applyPackageSettings(change.packageSettings, change.lastUpdate);
                                        break
    ...
    _loadDependencies() {
        ...
        QError = QuantalApiLib.QError
        QuantalError = QuantalApiLib.QuantalError
